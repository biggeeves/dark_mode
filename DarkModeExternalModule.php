...
class DarkModeExternalModule extends AbstractExternalModule
{
    ...
    private function createCSS()
    {
        ...
        $css = '<style>' .
            'body{' . 'color:' . $light_gray . '; background-color:' . $black . ';}' . PHP_EOL .
            '.menubox {background-color:' . $dark_gray . ';}' . PHP_EOL .
            'a, a:visited, a:link {color:' . $light_gray . ';}' . PHP_EOL .
            '.x-panel-header {' .
            ...
            '#west {' .
            'border-color: ' . $black . '; background-color:' . $dark_gray . ';}' . PHP_EOL .
            '#south {' .
            'border-color: ' . $black . ';' .
            'background-color:' . $black . ';' .
            '}' . PHP_EOL .
            '#pagecontainer {background-color:' . $black . ';}' . PHP_EOL .
            ...
            ' border-color:' . $black . ';' .
            '}' . PHP_EOL .
            '.table {color:' . $light_gray . ';' . '}' . PHP_EOL .
            '.external-modules-configure-button, .external-modules-disable-button, .external-modules-usage-button {' .
            'color:' . $light_gray . ';' .
            'background: transparent;' .
            '}' . PHP_EOL .

            '.labelrc, .labelmatrix, .data, .data2, .data_matrix {' .
            'background-color:' . $black . ' !important;' .
            'border-color:' . $black . ';' .
            'color:' . $white . ' !important;' .
            ';}' . PHP_EOL .

            '.flexigrid div.mDiv, .flexigrid div.hDiv, .flexigrid div.bDiv  {' .
            'background-color:' . $black . ';' .
            'color:' . $white . ';' .
            '}' . PHP_EOL .
            ...
            'textarea.x-form-field, .x-form-field {' .
            'background-color:' . $black . ' !important;' .
            'color:' . $white . ' !important;' .
            '}' . PHP_EOL .
            ...
            '.greenhighlight, .greenhighlight  table td{' .
            'color:' . $white . ' !important;' .
            'background-color:' . $dark_gray . ' !important;' .
            '}' . PHP_EOL .
